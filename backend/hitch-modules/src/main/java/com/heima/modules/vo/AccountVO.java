...
public class AccountVO implements VO {
     ...
     * 当前登录用户
     */
    @InitialResolver(resolver = InitialResolverType.CURRENTA_ACCOUNT, groups = {Group.All.class}) //TODO FH
    ...
    /**
     * JsonProperty.Access.READ_WRITE（默认）：既可序列化也可反序列化
     * JsonProperty.Access.READ_ONLY：只能序列化，不能反序列化
     * JsonProperty.Access.WRITE_ONLY：只能反序列化，不能序列化
     */
    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY) // TODO FH
